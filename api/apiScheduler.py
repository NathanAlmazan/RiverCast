...
def fetch_weather_data():
    ...
    response = requests.get('http://ec2-18-142-249-114.ap-southeast-1.compute.amazonaws.com:8000/post_to_db')
    end_time = time.time()
    
    if response.status_code == 200:
        print(f"Weather data fetched successfully in {end_time - start_time} seconds")
